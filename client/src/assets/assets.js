...
export const dummyTestimonial = [
  {
    ...
    rating: 5,
    feedback:
      "The course structure is fantastic. I went from knowing nothing about React to building full-scale applications in just weeks.",
  },
  {
    name: "Mike Ross",
    ...
    rating: 4.5,
    feedback:
      "Detailed explanations and great real-world examples. Highly recommended for anyone looking to upskill in backend technologies.",
  },
  {
    name: "Emily Blunt",
    ...
    rating: 5,
    feedback:
      "The Python for Data Science module was exactly what I needed. Clear, concise, and packed with actionable insights.",
  },
];
...
export const dummyCourses = [
  {
        ...
        chapterContent: [
          {
            ...
            lectureDuration: 25,
            lectureUrl: "https://youtu.be/NCwa_xi0Uuc?si=sSL6yqjNMZBS50g_",
            isPreviewFree: true,
            lectureOrder: 1,
          },
          {
    ...
    courseRatings: [{ userId: "user_105", rating: 4.5, _id: "rating_001" }],
        ...
        chapterContent: [
          {
            ...
            lectureDuration: 45,
            lectureUrl: "https://youtu.be/K5KVEU3aaeQ?si=OG5twO2kpwQQwZhU",
            isPreviewFree: true,
            lectureOrder: 1,
          },
        ],
  ...
  },
  {
        ...
        chapterContent: [
          {
            ...
            lectureDuration: 60,
            lectureUrl: "https://youtu.be/nu_pCVPKzTk?si=kWUCJSA3ZU-VDGEp",
            isPreviewFree: true,
            lectureOrder: 1,
          },
        ],
    ...
    courseRatings: [{ userId: "user_106", rating: 5, _id: "rating_002" }],
  ...
  },
  {
    ...
    courseDescription:
      "<h2>Secure the Future</h2><p>Learn to think like a hacker to defeat them. This course covers penetration testing, network security, and social engineering defenses.</p><ul><li>Kali Linux for Beginners</li><li>Wireless Network Attacks</li><li>Web Application Security (OWASP Top 10)</li></ul>",
    coursePrice: 99.99,
    isPublished: true,
    discount: 15,
    courseContent: [
        ...
        chapterContent: [
          {
            ...
            lectureDuration: 40,
            lectureUrl: "https://youtu.be/3Kq1MIfTWCE?si=xQNxjK0TYxjx8rNF",
            isPreviewFree: true,
            lectureOrder: 1,
          },
        ],
  ...
  },
  {
        ...
        chapterContent: [
          {
            ...
            lectureDuration: 600,
            lectureUrl: "https://youtu.be/70oYrSnRgoI?si=ej0Xv_jOSqCcUDUh",
            isPreviewFree: true,
            lectureOrder: 1,
          },
          {
    ...
    __v: 1,
    courseThumbnail: "https://i.ytimg.com/vi_webp/70oYrSnRgoI/hqdefault.webp",
  },
  {
    _id: "course_006",
        ...
        chapterContent: [
          {
            ...
            lectureDuration: 30,
            lectureUrl: "https://youtu.be/CMEWVn1uZpQ?si=OsGAkO6YsmvVEhh5",
            isPreviewFree: true,
            lectureOrder: 1,
          },
          {
  ...
  },
  {
        ...
        chapterContent: [
          {
            ...
            lectureDuration: 600,
            lectureUrl: "https://www.youtube.com/live/jgPChUZP57I?si=y1nScRD4iO3TMvDP",
            isPreviewFree: true,
            lectureOrder: 1,
          },
          {
    ...
    __v: 1,
    courseThumbnail: "https://i.ytimg.com/vi/jgPChUZP57I/hqdefault.jpg",
  },
  {
    _id: "course_008",
        ...
        chapterContent: [
          {
            ...
            lectureDuration: 700,
            lectureUrl: "https://youtu.be/z5nc9MDbvkw?si=1ziclik9a7x5SXQX",
            isPreviewFree: true,
            lectureOrder: 1,
          },
          {
    ...
    __v: 1,
    courseThumbnail: "https://i.ytimg.com/vi_webp/z5nc9MDbvkw/hqdefault.webp",
  },
];
