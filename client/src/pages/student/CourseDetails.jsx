...
const CourseDetails = () => {
  ...
  const sanitizedHTML = DOMPurify.sanitize(courseData.courseDescription || "");

  return (
    <>
    <div className="relative md:px-36 px-8 md:pt-30 pt-20 text-left flex md:flex-row flex-col-reverse gap-10 items-start justify-between">
      ...
      <div className="max-w-xl z-10 text-gray-500">
        ...
        <p className="text-sm">
          Course by <span className="text-blue-600 underline">Educator</span>
        </p>
      ...
      <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
        {
                  playerData ? <YouTube videoId = {playerData.videoId} opts={{playerVars:{autoplay:1}}} iframeClassName="w-full aspect-video h-64 md:h-80"/> :<img src={courseData.courseThumbnail} alt="" />
                }
            
            <div className="p-5">
              <div className="flex items-center gap-2">
                <img className="w-3.5" src={assets.time_left_clock_icon} alt="time left clock item" />
